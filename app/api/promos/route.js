...
export async function POST(request) {
  try {
    const { nombre, precio_mayor, precio_detal, num_piezas, descripcion, activo } = await request.json();
...
export async function PUT(request) {
  try {
    ...
    const { id, nombre, precio_mayor, precio_detal, num_piezas, descripcion, activo } = body;
