...
export const PERMISOS = {
  admin:    ['/dashboard','/inventario','/productos','/entrada','/salida','/historial','/alertas','/clientes','/comandas','/venta-directa','/etiquetas','/plan-tela','/logs','/usuarios','/reportes','/exhibicion'],
  vendedor: ['/dashboard','/inventario','/historial','/alertas','/clientes','/comandas','/venta-directa','/reportes','/exhibicion'],
