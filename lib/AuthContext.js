...
export const PERMISOS = {
  admin:    ['/dashboard','/inventario','/productos','/entrada','/salida','/historial','/alertas','/clientes','/comandas','/venta-directa','/etiquetas','/plan-tela','/logs','/usuarios','/reportes','/exhibicion','/envio-rapido'],
