...
export async function POST(request) {
  try {
    ...
    // Actualizar último acceso y log (sin bloquear si falla)
    ...
    // Crear sesión con expiración de 7 días
    ...
    // Setear cookie HttpOnly — no accesible desde JavaScript (protege contra XSS)
